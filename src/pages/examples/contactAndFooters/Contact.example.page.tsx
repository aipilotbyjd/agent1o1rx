...
import contactInfoWithFormExampleSource from '@/examples/contactAndFooter/contact/ContactInfoWithForm.example.tsx?raw'; // eslint-disable-line import/extensions
				...
				<div className='grid grid-cols-12 gap-4'>
					...
					<ExampleItemPartial
						...
						code={extractSnippetUtil(
							contactInfoWithFormExampleSource,
							'contactInfoWithFormExampleSource',
						)}>
