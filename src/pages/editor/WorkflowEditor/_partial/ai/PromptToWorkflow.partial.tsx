	...
	return (
		<div className='space-y-3'>
			<textarea
				...
				className='h-32 w-full rounded-xl border border-zinc-300 bg-white p-3 text-sm text-zinc-900 transition outline-none placeholder:text-zinc-500 focus:border-violet-400 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100'
			/>
			<button
				type='button'
				onClick={generate}
