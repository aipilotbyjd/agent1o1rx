...
const statusConfig: Record<string, { color: string; icon: string }> = {
	...
	running: { color: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-300', icon: 'Play' },
	success: { color: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-300', icon: 'CheckCircle' },
	error: { color: 'bg-rose-100 text-rose-700 dark:bg-rose-950/50 dark:text-rose-300', icon: 'AlertCircle' },
	stopped: { color: 'bg-amber-100 text-amber-700 dark:bg-amber-950/50 dark:text-amber-300', icon: 'Stop' },
};
