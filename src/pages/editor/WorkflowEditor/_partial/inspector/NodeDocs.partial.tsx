...
const NodeDocs = ({ def }: { def: TNodeDefinition }) => (
	<div className='rounded-xl border border-zinc-200 bg-white p-3 dark:border-zinc-800 dark:bg-zinc-950'>
		<div className='text-xs font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400'>Docs</div>
		<p className='mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300'>{def.description}</p>
