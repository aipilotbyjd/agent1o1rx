	...
	return (
		<header className='flex h-14 shrink-0 items-center gap-2 border-b border-zinc-800 bg-zinc-950 px-3'>
			<button
				...
				className='rounded-lg border border-zinc-800 px-3 py-2 text-xs font-bold text-zinc-300 hover:text-white'>
				Library
			</button>
			<Link
				to='/'
			...
			<input
				...
				className='min-w-0 max-w-md flex-1 rounded-lg border border-transparent bg-transparent px-3 py-2 text-sm font-black text-white outline-none hover:border-zinc-800 focus:border-emerald-400'
			/>
			<div className='ml-auto flex items-center gap-2'>
				<button
					...
					className='rounded-lg border border-zinc-800 px-3 py-2 text-xs font-bold text-zinc-300 disabled:opacity-30'>
					Undo
				</button>
				<button
					type='button'
				...
				<button
					...
					className='rounded-lg border border-violet-400/30 bg-violet-400/10 px-3 py-2 text-xs font-bold text-violet-100'>
					AI
				</button>
				<button
					type='button'
